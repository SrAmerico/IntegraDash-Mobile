...
//
//                val urlImage = "http://172.16.52.44:8099/img/" + imagemPerfilUsuario
//
//                //Usar Picasso para carregar e exibir a imagem no ImageView
//                Picasso.get().load(urlImage).into(viewImagemPerfil)
//
//            }
//
